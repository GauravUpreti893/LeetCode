...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input :</strong> <br>arr[] = {{1,2},{2,3},{3,4},{4,5},{6,7},{9,10}}
N = 10 and M = 6
...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input :</strong> <br>arr[ ] = {{1, 2}}
N = 2 and M = 1 <strong>
Output :</strong> <br>3
<strong>Explanation:
