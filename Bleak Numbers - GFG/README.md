...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input: <br></strong>4
...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input:</strong>&nbsp;<br>3
