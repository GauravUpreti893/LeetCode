...
<pre style="user-select: auto; position: relative;">int[] nums = [...]; // Input array
...
<pre style="user-select: auto; position: relative;"><strong style="user-select: auto;">Input:</strong> nums = [1,1,2]
...
<pre style="user-select: auto; position: relative;"><strong style="user-select: auto;">Input:</strong> nums = [0,0,1,1,1,2,2,3,3,4]
